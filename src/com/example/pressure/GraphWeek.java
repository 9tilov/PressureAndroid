...
public class GraphWeek extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.week_graph);
		stat_id = getIntent().getStringExtra("id_stat_key_week");
		count_data_string = getIntent().getStringExtra("id_stat_count_week");

		Log.d(LOG_TAG, "stat_idggg = " + stat_id);
		Log.d(LOG_TAG, "count_data_stringfff = " + count_data_string);
		LinearLayout layout = (LinearLayout) findViewById(R.id.graphWeek);
